		...
		calElement.fullCalendar({
			...
			eventRender: function (event, element) {
				...
				var new_description =
					...
					'<img style="padding-top:2px;" class="pull-left" src="https://ep7t6ae.cloudimg.io/s/height/25/' + event.home_team.logo + '">' +
					'<img style="padding-top:2px;" class="pull-right" src="https://ep7t6ae.cloudimg.io/s/height/25/' + event.away_team.logo + '">' +
